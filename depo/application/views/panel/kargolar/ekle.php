<?php foreach ($sonkargo as $sk);?>
<div class="container-fluid">

    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Kargo İşlemleri</h1>
    </div>


    <form method="POST"  id="f_ekle" action="<?=base_url();?>kargolar/ekle" class="wpcf7-form"   enctype="multipart/form-data">

        <div class="row">

            <div class="col-lg-12">

                <input hidden type="text" id="ic_dis_durumu" name="ic_dis_durumu" value="yurt_disi">
                <input hidden type="text" id="id" name="id" value="<?=$sk->veri_id?>">
                <input hidden type="text" id="data_durumu" name="data_durumu" value="">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="yeni_data" name="yeni_data">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div id="eski_adres_alan" class="card-body">

                        <div class="form-row">

                            <div id="eski_adres" class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control" id="eski_ulke" name="eski_ulke" placeholder="Ülke">
                    ...
                    <div id="adres_alan" class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="ulke">Ülkeler</label>
                                <select class="form-control" id="ulke" name="ulke" placeholder="Ülke">
                                    <option value="" >Ülke Seç</option>
                                    <?php foreach($ulkeler as $ulke){?>
                                        <option value="<?=$ulke->id?>"><?=$ulke->baslik?> (<?=$ulke->rewrite?>) </option>
                                    <?php }?>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div id="iletisim_alan" class="card-body">
                        <div id="iletisim">
                    ...
                    <div id="iletisim_alani_eski" class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="telefon_no" id="telefon_no" placeholder="Telefon Numarası">
                            </div>



                            <div class="form-group col-md-6">
                                <label for="inputPassword4">E-Posta</label>
                                <input type="text" class="form-control" id="email" name="email" placeholder="E-Posta (Opsiyonel)">
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="fiyat" name="fiyat" placeholder="Fiyat">
                                    </div>
                                    ...
                                    <div hidden class="form-group col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="yurt_disi" name="yurt_disi" checked>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="inputEmail4">m3 Hesapla</label>
                                        <button type="button"  class="btn btn-warning" style="color:black; width: 100%;" id="desi_sonuc">Hesapla</button>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="inputEmail4">m3 Sonucu</label>
                                        <input type="text" class="form-control" id="hesaplanan_desi" name="hesaplanan_desi" disabled>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="toptanci" name="toptanci" placeholder="Toptancı Bilgileri">
                                    </div>


                                    <div class="form-group col-md-12">
                                        <label for="inputEmail4">Kargo Adeti</label>
                                        <input type="text" class="form-control" id="kargo_adet" name="kargo_adet" placeholder="Kargo Adeti">
                                    </div>

                                    <div id="" class="form-group col-md-12">
                                        <label for="inputEmail4">Ebat Kilo Bilgileri</label>
                                        <textarea class="form-control" name="ebat_kilo" id="ebat_kilo" cols="120" rows="3"></textarea>
                                    </div>
    ...
    $('#musteri_eski').on('change', function() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                setTimeout(() => {
                    $('#telefon_no').val(telmusteski);


                    $("#kod").val(data_kod_eski);
