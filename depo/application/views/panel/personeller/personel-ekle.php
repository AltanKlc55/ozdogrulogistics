<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Personel İşlemleri</h1>
    </div>
                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="ad_soyad" placeholder="Ad" required>
                            </div>


                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Tel No</label>
                                <input type="text" class="form-control" id="tel_no" placeholder="Telefon Numarası" required>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="sifre" placeholder="Şifre" required>
                            </div>
...
<script>
    ...
    $('#kaydet').click(function(){
        ...
        var data = "ad_soyad="+$('#ad_soyad').val()+"&tel_no="+$('#tel_no').val()+"&email="+$('#email').val()+"&sifre="+$('#sifre').val();
        var bos = "0";
        $.ajax({
            url: "<?=base_url();?>personeller/ekle",
            type: "post",
            data: data,
