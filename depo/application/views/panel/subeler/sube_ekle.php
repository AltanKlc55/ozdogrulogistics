                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="sube_adi" placeholder="Ad" required>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="sube_konumu" placeholder="Açık Adres" required>
                            </div>
...
<script>
    ...
    $('#kaydet').click(function(){
        ...
        var data = "sube_adi="+$('#sube_adi').val()+"&sube_bolgesi="+$('#sube_bolgesi').val()+"&sube_konumu="+$('#sube_konumu').val();
        var bos = '';
        $.ajax({
            url: "<?=base_url();?>subeler/ekle",
            type: "post",
            data: data,
