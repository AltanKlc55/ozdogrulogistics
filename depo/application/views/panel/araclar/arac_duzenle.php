        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Araç Düzenle</h6>
                </div>
                <div class="card-body">
                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="marka" placeholder="Marka" value="<?=$tek->marka?>" required>
                            </div>

                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Model</label>
                                <input type="text" class="form-control" id="model" placeholder="Model" value="<?=$tek->model?>" required>
                            </div>


                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Metre Küp</label>
                                <input type="text" class="form-control" id="metre_kup" placeholder="Metre Küp" value="<?=$tek->metre_kup?>" required>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="plaka" placeholder="Plaka" value="<?=$tek->plaka?>" required>
                            </div>
...
<script>
    ...
    $('#kaydet').click(function(){
        ...
        var data = "id="+<?=$tek->id;?>+"&marka="+$('#marka').val()+"&model="+$('#model').val()+"&metre_kup="+$('#metre_kup').val()+"&plaka="+$('#plaka').val()+"&sube="+$('#sube').val()+"&status="+"1";
        var bos = '';
        $.ajax({
            url: "<?=base_url();?>araclar/duzenle",
            type: "post",
            data: data,
